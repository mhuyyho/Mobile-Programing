...
class SignupActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val root = findViewById<View>(R.id.signup)
        ...
        val usernameInclude = findViewById<View?>(R.id.include_username)
        ...
        configureLinearInput(usernameInclude, R.drawable.name, "Username", MODE_TEXT)
    ...
    private fun configureLinearInput(includeRoot: View?, iconRes: Int, hint: String?, mode: Int) {
        if (includeRoot == null) return
